...
//   const date_on_fact =
//     toDate(raw.F81_290_RECOVERYDATETIME || obj.recoveryDateTime, true) ||
//     null;
...
//   const team_action = clean(raw.BRIGADE_ACTION) ?? null;
//   const datetime_team_action =
//     toDate(raw.CREATE_DATETIME, true) || null;
...
//   const condition =
//     clean(raw.STATUS_NAME) ?? clean(obj.STATUS_NAME) ?? null;

//   const NumberField =
//     clean(raw.HOUSE_LIST) ?? clean(obj.HOUSE_LIST) ?? null;
