...
import styles from "./BrandSunLoader.module.css";
...
const sunPathAnimation = {
  opacity: [0.42, 1, 0.72],
  pathLength: [0.35, 1, 1],
  fill: ["rgba(227, 112, 33, 0.28)", "rgba(227, 112, 33, 1)", "rgba(227, 112, 33, 0.82)"],
};

export default function BrandSunLoader({
  size = 42,
  text = "",
  fullscreen = false,
  className = "",
  ...
  const loader = (
    <div
      ...
      style={{ "--brand-sun-loader-size": `${size}px` }}
    >
      <motion.svg
      ...
      >
        {SUN_PATHS.map((path, index) => (
          <motion.path
            ...
            initial={{ opacity: 0.42, pathLength: 0.35, fill: "rgba(227, 112, 33, 0.28)" }}
            animate={sunPathAnimation}
            transition={{
              duration: 1.6,
              ease: "easeInOut",
              repeat: Infinity,
